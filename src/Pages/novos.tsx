...
const CadastroProduto = () => {
  ...
  async function handleInputs(event: { preventDefault: () => void }) {
    ...
    try {
      ...
      console.log(`nOME: ${name}`), formData.append("name", Name);
  ...
  // console.log(`Nome: ${file.name}, Tamanho: ${file.size} bytes`);
  // });
